...
public class Permiso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2=findViewById(R.id.botonedad);
        btn2.setEnabled(false);
        check1=findViewById(R.id.checkBox1);
        check1.setText("Al usar este sitio, reconoces haber leido  " +
                "y entendido nuestra Política de Cookies, " +
        ...
        String texto="POLÍTICA DE PRIVACIDAD\n" +
                "El presente Política de Privacidad establece los términos en que Covid Trakin usa y protege la" +
                ...
                "Covid Trakin está altamente comprometido para cumplir con el compromiso de mantener su " +
                ...
                "cookies, sin embargo la mayoría de navegadores aceptan cookies automáticamente pues sirve " +
                ...
                "Covid Trakin Se reserva el derecho de cambiar los términos de la presente Política de Privacidad " +
    ...
    {//REGRESA AL ACTIVITY ANTERIOR
        ...
        startActivity(c);*/
        Toast.makeText(Permiso.this, "Gracias por su tiempo ", Toast.LENGTH_LONG).show();
    }
    public void Aceptar(View view)
    {
        //MANDA AL ACTIVITY SIGUIENTE CUANDO ACEPTA LAS POLITICAS Y PRIVACIDAD
        /*Intent c=new Intent(this,MainActivity.class);
        startActivity(c);*/
        startActivity(new Intent(Permiso.this,MainActivity.class));
        finish();
    }
}